...
namespace ExemploApiCatalogoJogos.Controllers.V1
{
    ...
    {
        //para testar a comparação
        //quando aplicação sobre em memória gera uma instância do recurso
        //mantêm até o final do ciclo do projeto (até aplicação sair do ar)
    ...
    public class ExemploCicloDeVida : IExemploSingleton, IExemploScoped, IExemploTransient
    {
        ...
        {
            _guid = Guid.NewGuid(); //Gera um novo Id
        }

        public Guid Id => _guid; //Retorna o novo Id
    }
